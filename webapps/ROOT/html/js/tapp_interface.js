...
//And inquires the internal server information operating in the phone.
...
function AWI_setServiceList(serviceIds, callType) {
	var sReturn = "{ \"result\":\"FAIL\" , \"value\":{} }"
...
function AWI_getServiceList() {
	var sReturn = "{ \"result\":\"FAIL\" , \"value\":{} }"

	 var joCmd = null;
	 var params = new Object();
	 params['cmd'] = "getServiceList";
	 joCmd = {func:params};
...
function AWI_goServiceApp(serviceId) {
	var sReturn = "{ \"result\":\"FAIL\" , \"value\":{} }"

	if(!AWI_ENABLE) return;
	 var joCmd = null;
	 var params = new Object();
	 params['cmd'] = "goServiceApp";
...
function AWI_isAbleTestNet() {
	if(!AWI_ENABLE) return;
	 var joCmd = null;
	 var params = new Object();
	 params['cmd'] = "isAbleTestNet";
	 joCmd = {func:params};
	 if(AWI_DEVICE == 'ios') {
		sReturn =  prompt(JSON.stringify(joCmd));	
	 } else if(AWI_DEVICE == 'android') {
...
function AWI_isAbleDebugNet() {
	if(!AWI_ENABLE) return;
	 var joCmd = null;
	 var params = new Object();
	 params['cmd'] = "isAbleDebugNet";
	 joCmd = {func:params};
	 if(AWI_DEVICE == 'ios') {
		sReturn =  prompt(JSON.stringify(joCmd));	
	 } else if(AWI_DEVICE == 'android') {
