...
String createTokenFee = CoinListVO.getCreateTokenFee();
%>
<!DOCTYPE html>
<html>
  ...
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.4.2/css/all.css" integrity="sha384-/rXc/GQVaYpyDdyxK+ecHPVYJSN9bmVFBvjA/9eOB+pb3F2w2N6fc5qB9Ew5yIns" crossorigin="anonymous">
	...
	function FnCreateToken() {
		if(myBalance < parseInt("<%=createTokenFee%>")) {
			$.alert('잔액이 부족합니다.');
			return false;
		}
		...
		setTimeout(function() {
			...
			var displayParam = [];
			AWI_runTransaction("createToken", sArgs, "FnCallBackFunction", "Create Token", "", displayParam, j_curWID, parseInt("<%=createTokenFee%>"));
