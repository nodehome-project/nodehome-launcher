...
<html>
	...
	function AWI_OnLoadFromApp(dtype) {
		...
		AWI_setPassword("1234");
		AWI_setAccountConfig("ACCOUNT_NM","wallet"); 	// NAME Save
	...
	function FnCreateWallet() {
		...
		if (checkNull(createWalletRestoreForm.txt_MemPwd.value)==true) {
			alertMassage("<spring:message code="user.msg.password" />");
			createWalletRestoreForm.txt_MemPwd.value="";
			return;
		}
		if (checkNull(createWalletRestoreForm.txt_MemPwd2.value)==true) {
			alertMassage("<spring:message code="user.msg.passwordconfirm" />");
			createWalletRestoreForm.txt_MemPwd2.value="";
			return;
		}
		sWID=createWalletRestoreForm.wid.value;
		sName=createWalletRestoreForm.walletName.value;
		AWI_setPassword(createWalletRestoreForm.txt_MemPwd.value);
	...
	<div class="container">
		...
		<div class="row">
		    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
				...
				<dl>
					<dt><h2><small>임시 계정</small></h2></dt>
					<dd class="oaerror warning" style="word-break:break-all;">
					<p>계정명 : wallet</p>
					<p>비밀번호 : 1234</p>
					<p style="color:blue;">희망하는 계정명과 비밀번호를 설정하세요.</p>
					</dd>
				</dl>
