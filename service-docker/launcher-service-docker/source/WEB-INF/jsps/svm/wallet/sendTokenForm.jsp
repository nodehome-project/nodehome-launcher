...
String feeMin = CoinListVO.getFeeMin();
%>
<!DOCTYPE html>
<html>
  ...
  <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.4.2/css/all.css" integrity="sha384-/rXc/GQVaYpyDdyxK+ecHPVYJSN9bmVFBvjA/9eOB+pb3F2w2N6fc5qB9Ew5yIns" crossorigin="anonymous">
	...
	function getTokenBalance(pWalletId) {
		sQuery = {"walletID":pWalletId, "tokenId" : "<%=token_id%>"};
	...
	function FnTransferCoin() {
		...
		setTimeout(function () {
			...
			var displayParam = [];
			AWI_runTransaction("sendToken", sArgs, "FnCallBackTransferCoin", "송금확인", "", displayParam, j_curWID, parseInt("<%=feeMin%>"));
		}, 10);
	}
